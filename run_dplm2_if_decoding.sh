#!/bin/bash
# Usage: bash run_dplm2_if_decoding.sh <dataset> <model_name> <strategy_name> <hyperparam_tag> <decoding_strategy_string>
# Example: bash run_dplm2_if_decoding.sh cameo2022 dplm2_650m dinfer_threshold t0.8 "dinfer_threshold@0.8"
#
# Fixed settings: deterministic unmasking, argmax sampling, no_remask remasking
# Output path: generation-results/decoding_strategy/{dataset}/{model_name}/{strategy_name}/{hyperparam_tag}/inverse_folding
